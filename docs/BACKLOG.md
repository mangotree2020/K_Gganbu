...
| #9  | 전화 OTP             | ✅   | 2026-07-01 E2E 검증 — **Twilio Verify**(PLANNING 원안 NHN→Twilio 변경) + Supabase Test Phone Numbers로 signInWithOtp→verifyOtp(type:sms)→세션 발급 확인(+821090989425). ※실 SMS 발송은 Twilio 계정 업그레이드 필요(trial=verified 번호 한정), Geo Permissions Korea(+82) 허용됨                                                                                                                                                                                                                                                                                                                                                      |
| #10 | 온보딩 — 언어        | ✅   |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| #11 | 온보딩 — 지역·관심사 | ✅   |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| #12 | 홈 — 3대 버튼·위젯   | ✅   |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| #13 | 텍스트 번역 mock     | ✅   |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
...
> 실기기/E2E 검증 ✅ — #9 Phone OTP(Twilio Verify + 테스트번호로 발송→검증→세션).
> 미설정 — #8 Apple provider(D-U-N-S 대기). 실 SMS 발송은 Twilio 계정 업그레이드 시점 과제(구현·연동은 검증 완료).
