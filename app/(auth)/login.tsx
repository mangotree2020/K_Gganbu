...
function GoogleIcon() {
  return (
    <Svg width={18} height={18} viewBox='0 0 18 18'>
      <Path fill='#4285F4' d='M17.64 9.2c0-.638-.057-1.252-.164-1.84H9v3.481h4.844a4.14 4.14 0 0 1-1.796 2.716v2.258h2.908C16.658 14.38 17.64 12.07 17.64 9.2z' />
      <Path fill='#34A853' d='M9 18c2.97 0 5.46-.98 7.28-2.66l-2.908-2.258c-.98.66-2.23 1.05-3.372 1.05-2.59 0-4.786-1.75-5.57-4.1H.43v2.33A9 9 0 0 0 9 18z' />
      <Path fill='#FBBC05' d='M3.43 10.032a5.4 5.4 0 0 1 0-3.444V4.258H.43A9 9 0 0 0 0 9c0 1.452.348 2.826.43 4.03l3-3z' />
      <Path fill='#EA4335' d='M9 3.58c1.458 0 2.77.5 3.8 1.48l2.85-2.85C13.95.48 11.67 0 9 0A9 9 0 0 0 .43 4.258l3 2.33C4.214 4.63 6.41 3.58 9 3.58z' />
    </Svg>
  )
}
  ...
  return (
    <TouchableOpacity
      ...
      <View style={{ flex: 1, alignItems: 'center' }}>
        <RNText style={{ fontSize: 15, fontWeight: '600', color: textColor }}>
          {label}
        </RNText>
      </View>
      {/* 우측 여백 (아이콘 너비 상쇄) */}
      ...
      <KeyboardAvoidingView
        ...
        <View style={{ paddingHorizontal: 20, paddingTop: 4, paddingBottom: 2 }}>
          ...
          <View style={{ flexDirection: 'row', alignItems: 'center', gap: 10 }}>
            ...
            <View>
              <RNText style={{ fontSize: 18, fontWeight: '700', color: '#18181B', letterSpacing: -0.3 }}>
                K-Gganbu
              </RNText>
              <RNText style={{ fontSize: 10, color: '#0EA5E9', fontWeight: '600', letterSpacing: 0.5 }}>
        ...
        <ScrollView
          ...
          <View style={{ gap: 4, marginBottom: 16 }}>
            <RNText style={{ fontSize: 26, fontWeight: '700', color: '#18181B', letterSpacing: -0.5 }}>
              Welcome back 👋
            </RNText>
          ...
          <View style={{ marginBottom: 12 }}>
            ...
            {errors.email && (
              <RNText style={{ fontSize: 12, color: '#EF4444', marginTop: 4 }}>{errors.email.message}</RNText>
            )}
          </View>
          ...
          <View style={{ marginBottom: 8 }}>
            ...
            {errors.password && (
              <RNText style={{ fontSize: 12, color: '#EF4444', marginTop: 4 }}>{errors.password.message}</RNText>
            )}
          </View>
          ...
          {error && (
            <RNText style={{ fontSize: 13, color: '#EF4444', textAlign: 'center', marginBottom: 12 }}>
              {error.message}
            </RNText>
          )}
          ...
          {/* 약관 푸터 */}
          <View style={{ flexDirection: 'row', justifyContent: 'center', flexWrap: 'wrap', gap: 3 }}>
            <RNText style={{ fontSize: 12, color: '#A1A1AA' }}>By continuing you agree to our</RNText>
            <Pressable>
              <RNText style={{ fontSize: 12, color: '#71717A', fontWeight: '600' }}>Terms</RNText>
            </Pressable>
            <RNText style={{ fontSize: 12, color: '#A1A1AA' }}> & </RNText>
            <Pressable>
              <RNText style={{ fontSize: 12, color: '#71717A', fontWeight: '600' }}>Privacy Policy</RNText>
            </Pressable>
          </View>
